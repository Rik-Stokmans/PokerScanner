...
- [ ] when i put 2 cards on the scanner only 1 of the 2 rfid readers detects a card and when i switch the 2 cards to the other scanner the other one gets scanned.
- [ ] the icon in the top of the table tab that displays how many players are in the game should be clickable and open the invite to table page
- [ ] in the table setup page the host should be able to remove people/bots from the table
- [ ] when opening the invitations tab i get this error
